...
<body>
    <header>
        <nav>
            <ul>
                <li>
                    <a href="{{ route('tests.createquestion', $id) }}">New Question</a>
                </li>
                <li>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('questions.answer', ['id' => $id,'question_id' => $question->id]) }}" class="btn btn-warning">Details</a>
                            <form action="{{ route('questions.destroy', ['id' => $question->id,'test_id' => $id]) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
